...
const Home: React.FC = () => {
  ...
  return (
    <div className="home-page bg-bg grid grid-cols-1 lg:grid-cols-[350px_1fr] gap-8 ">
      <section className="flex flex-col justify-start items-start gap-4 bg-primary border border-border rounded-md p-6">
        <h1 className="text-accent text-2xl/[24px] font-bold ">Parameters</h1>
        <div className="w-full h-[1px] bg-border"></div>
        <YantrasParametersForm setModelPath={setModelPath}/>
      </section>
      <section className="flex h-full flex-col justify-start items-start gap-4 bg-primary border border-border rounded-md p-6">
